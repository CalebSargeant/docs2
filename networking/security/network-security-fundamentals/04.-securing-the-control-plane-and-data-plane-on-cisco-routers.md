...
![Packet capture showing OSPF Auth Type as Cryptographic](../../../.gitbook/assets/securing-control-plane-and-data-plane-on-cisco-routers-ospf2.png)
...
**Policy Maps**
Can apply policy such as policing bandwidth, priority, or drop the traffic.

**Class Maps**
Matches traffic based on ACLs, VLANs, protocols, QoS attributes
